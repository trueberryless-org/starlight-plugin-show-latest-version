...
Whether to show the latest version of your Starlight plugin in the site title.

:::note
If you enable this feature, you will have to add an [Astro adapter](https://astro.build/integrations/?search=&categories%5B%5D=adapters) because the plugin override now uses [`server:defer`](https://docs.astro.build/en/guides/server-islands/) in order to fetch the latest version of your package.
